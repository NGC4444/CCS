...
class LSTMClassifier(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim, replicate_labels_indicator):
        ...
        self.lstm = nn.LSTM(input_dim, hidden_dim, layer_dim, batch_first=True, dropout=0.2).double()
        self.dropout = nn.Dropout(0.5).double()
    ...
    def forward(self, x):
        ...
        out, (hn, cn) = self.lstm(x, (h0.double(), c0.double()))
