...
class ResidualGANLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim, freeze_indices=[]):
        ...
        self.lstm = nn.LSTM(input_dim, hidden_dim, layer_dim, batch_first=True, dropout=0.4).double()
        self.fc1 = nn.Linear(hidden_dim, output_dim - len(self.freeze_indices)).double()
        self.fc2 = nn.Linear(hidden_dim, output_dim - len(self.freeze_indices)).double()
...
class BidirectionalLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim):
        ...
        self.layer_dim = layer_dim
        self.output_dim = output_dim
        self.lstm = nn.LSTM(input_dim, hidden_dim, layer_dim, batch_first=True, dropout=0.4, bidirectional=True).double()
        self.fc = nn.Linear(2 * hidden_dim, output_dim).double()
        self.act = nn.Sigmoid()
    ...
    def init_hidden(self, x):
        h0 = torch.zeros(2 * self.layer_dim, x.size(0), self.hidden_dim).double() 
        c0 = torch.zeros(2 * self.layer_dim, x.size(0), self.hidden_dim).double() 
        return [t.to(device) for t in (h0, c0)]
...
class BidirectionalResidualGANLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim, freeze_indices=[]):
        ...
        self.lstm = nn.LSTM(input_dim, hidden_dim, layer_dim, batch_first=True, dropout=0.3, bidirectional=True).double()
        self.fc1 = nn.Linear(2 * hidden_dim, output_dim - len(self.freeze_indices)).double()
        self.fc2 = nn.Linear(2 * hidden_dim, output_dim - len(self.freeze_indices)).double()
