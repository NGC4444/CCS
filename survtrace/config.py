...
STConfig = EasyDict(
    {
        ...
        'vocab_size': 5, # num of all possible values of categorical features
        'hidden_size': 25, # embedding size
        'intermediate_size': 64, # intermediate layer size in transformer layer
        'num_hidden_layers': 3, # num of transformers
        'num_attention_heads': 5, # num of attention heads in transformer layer
        'hidden_dropout_prob': 0.0,
        "in_fea":25,
        'num_feature': 16, # num of covariates of patients, should be set during load_data
