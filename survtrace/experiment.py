...
def main():
    ...
    for rep in range(args.num_reps):
        ...
        model.build_model(args=args, device=device, num_features=num_features, bidirectional=True, hidden_dim_generator=256, layer_dim_generator=2, hidden_dim_discriminator=16, layer_dim_discriminator=1, classifier_model_name="lstm_classifier")
    ...
    torch.save(model, 'counterfactuals/countfactual_model.pt')
